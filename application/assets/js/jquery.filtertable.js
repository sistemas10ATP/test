...
(function($) {
    ...
    $.fn.filterTable = function(options) { // define the filterTable plugin
        var defaults = { // start off with some default settings
                ...
                inputSelector:     '#busqueda',                // use the element with this selector for the filter input field instead of creating one
                inputName:         '',                  // name of filter input field
                inputType:         'search',            // tag name of the filter input tag
                label:             'Filtrar:',           // text to precede the filter input tag
                ...
                placeholder:       'Ingresa tú búsqueda', // HTML5 placeholder text for the filter field
