...
abstract class Zend_Db_Adapter_Pdo_Abstract extends Zend_Db_Adapter_Abstract
{
    ...
    protected $tipo_de_base      = 'SQL Server';
    protected $host              = 'SQL03\DB03';
    protected $nombre_de_base    = 'AXTEST';
    protected $usuario           = 'sa';
    protected $contrasena        = 'avanceytec';
    ...
    protected function _dsn()
    {
       ...
       // return $this->_pdoType . ':Server=SQL03\DB03;dbname=AXTEST;';
