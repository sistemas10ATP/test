...
class makeTicket {
    ...
    protected $userKey = "B65357F2-74FB-4530-B859-1C336521D43A";
    protected $user = "";
    protected $text = "";
    ...
    public function send() {
        ...
        try {
            $res = $this->postAPI("http://tickets/sdpapi/request", $this->buildData(), null, false);
    ...
    private function buildXML() {
        ...
        $xml = "<Operation>"
                ...
                . "<parameter><name>subject</name><value>Incidencia en la aplicacion Inax.</value></parameter>"
                ...
                . "<parameter><name>site</name><value>Chihuahua</value></parameter>"
                ...
                . "<parameter><name>category</name><value>InAX</value></parameter>"
                . "<parameter><name>subcategory</name><value>Falla INAX</value></parameter>"
    ...
    public function sendAttachment($woId = false) {
        try {
            ...
            $key = $this->userKey;
            $wo = $woId;
            $url = "http://tickets/sdpapi/request/{$wo}/attachment?OPERATION_NAME=ADD_ATTACHMENT&TECHNICIAN_KEY={$key}";
